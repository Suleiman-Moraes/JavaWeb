...
SELECT AVG(salario) FROM funcioanrios;
SELECT AVG(salario) FROM funcioanrios WHERE departamento = 'TI';
SELECT AVG(salario) FROM funcioanrios WHERE departamento = 'Jurídico';
