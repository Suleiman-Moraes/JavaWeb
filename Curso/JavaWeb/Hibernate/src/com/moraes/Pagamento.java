...
public class Pagamento implements java.io.Serializable {
	...
	public Pagamento(PagamentoId id, String dataincricao) {
		this.id = id;
		this.dataincricao = dataincricao;
	}
	
	public Pagamento(Pagamento objeto) {
		this.id = objeto.id;
		this.dataincricao = objeto.dataincricao;
	}
	...
	public String toString() {
		return "Pagamento ID == " + id + ", Data de Inscrição == " + dataincricao;
	}
